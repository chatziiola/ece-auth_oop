...
public:
     ...
     * on three conditions. Firstly, all squares must be inside grid bounds. Secondly, all squares
     * must not be already occupied by other ships. Thirdly, all squares must not be already hit.
     *
